...
contract LibraShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        libraShare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        libraShare.safeTransfer(msg.sender, amount);
    }
}

contract Boardroom is LibraShareWrapper, ContractGuard, Operator {
    using SafeERC20 for IERC20;
    ...
    constructor(IERC20 _libra, IERC20 _libraShare) public {
        libra = _libra;
